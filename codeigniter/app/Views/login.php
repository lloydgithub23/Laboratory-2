...
<body>
        ...
        <div class="menu">
            <ul>
                <li class="logo">
                    ...
                    <li class="menu-item hidden"><a href="#">Login</a>
                    <li class="menu-item hidden"><a href="http://localhost/codeigniter/public/index.php/register">Register</a>
                </li>
            </ul>
        </div>
    </header>
    ...
    <section>
        ...
        <form method="post" action="<?= base_url('/verifylogin')?>">
    <? csrf_field()?>


    <div style="text-align: center;">
        <input type="text" name="username" placeholder="Username" required
            style="width: 100%; max-width: 500px; height: 50px; padding: 10px; font-size: 20px;
            margin-bottom: 15px; border-radius: 8px; border: 2px solid #ccc;" /><br>
    </div>
    ...
    <div style="text-align: center;">
        <button type="submit" style="width: 200px; height: 40px; font-size: 22px;
            background-color: #800080; color: white; border: none; border-radius: 8px; cursor: pointer;">
            Log In
        </button>
    </div>
